...
DESC_PREFIX="【琉🔹芸❤广告勿信👉剧情】📢"
def _with_prefix(s):
 s=s or""
 if not s or s.startswith(DESC_PREFIX):return s
...
class Spider(B):
 ...
 def detailContent(self,ids):
  ...
  o={"vod_id":v,"vod_name":d.get("name")or e.get("name",""),"vod_pic":d.get("cover",""),"vod_year":d.get("year",""),"vod_area":d.get("area",""),"vod_score":str(d.get("score")or""),"vod_actor":d.get("star",""),"vod_director":d.get("director",""),"vod_content":_with_prefix((d.get("introduce")or"").replace("&","／")),"type_name":d.get("classify","")}
